...
cl /Fe:%BINARY_NAME% %CFLAGS% -I%SRC_DIR% -I%TESTS_DIR% -I%MAYORANA_DIR% -I%MAYORANA_REF%/reflection_includes.h %MAIN_FILE% -D%FLAGS% /link user32.lib D3D11.lib d3dcompiler.lib /SUBSYSTEM:CONSOLE /nologo
